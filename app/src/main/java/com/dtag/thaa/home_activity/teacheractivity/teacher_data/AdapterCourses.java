...
public class AdapterCourses extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    List<ModuleAdapterCourses> groupData;
   ...
   // private SetShapeD setShapeD;
    ...
    public AdapterCourses(Context context, List<ModuleAdapterCourses> groupData, Onclicklistenerd onclicklistener ) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_add_course, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, int i) {
        ModuleAdapterCourses groupData1=  groupData.get(i);
        ...
        ((GroupViewHolder) viewHolder).durationName.setOnClickListener(new View.OnClickListener() {
            @Override
