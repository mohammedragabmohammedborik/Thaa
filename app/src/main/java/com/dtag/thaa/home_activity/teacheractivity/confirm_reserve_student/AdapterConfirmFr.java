...
public class AdapterConfirmFr extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
   ...
   // private SetShapeD setShapeD;
    ...
    public AdapterConfirmFr(Context context, List<ModuleAdapterDuration> groupData, Onclicklistenerd onclicklistener ) {
