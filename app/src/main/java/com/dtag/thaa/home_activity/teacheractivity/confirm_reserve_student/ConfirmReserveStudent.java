...
import com.dtag.thaa.home_activity.teacheractivity.durationfragment.AdapterDuration;
...
public class ConfirmReserveStudent extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.confirm_reserve_student, container, false);
...
//    }
    ...
    public void getAvailableTeacher() {
        ...
        adapterCourses = new AdapterConfirmFr(getActivity(), workList, new Onclicklistenerd() {
            @Override
