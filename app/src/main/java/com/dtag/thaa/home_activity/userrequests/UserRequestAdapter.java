...
public class UserRequestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    List<UserRequestModuleDataAdapter> groupData;
   ...
   // private SetShapeD setShapeD;
    ...
    public UserRequestAdapter(Context context, List<UserRequestModuleDataAdapter> groupData, Onclicklistenerd onclicklistener ) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_user_requests, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, int i) {
        UserRequestModuleDataAdapter groupData1=  groupData.get(i);
        ...
        ((GroupViewHolder) viewHolder).detailsName.setText(groupData1.getDetails());
...
//                .into(((GroupViewHolder) viewHolder).image_icon);
    ...
    public   class  GroupViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public GroupViewHolder(@NonNull View itemView) {
            ...
            detailsName=(TextView)itemView.findViewById(R.id.status_id);
            deleteIcon=(ImageView) itemView.findViewById(R.id.delete_request);
